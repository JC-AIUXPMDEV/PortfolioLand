      ...
      <div className="project-detail">
        ...
        <div className="project-body">
          ...
          <section className="project-section">
            ...
            <p>I didn't act on that frustration immediately. Instead, I spent time walking pet industry trade shows — both as an attendee and working booths alongside friends who owned existing pet brands.</p>
            <p>What I found confirmed the personal observation at a market level: the entire category was dominated by big-box brands knocking each other off, with no meaningful innovation in design or function. The buyers at these shows skewed toward exactly the demographic I knew — design-conscious, modern-living pet owners in their 30s and 40s who spent real money on their homes but had zero options for their pets that didn't look like an eyesore.</p>
          ...
          <section className="project-section">
            ...
            <p>The NomNom Bowl came from a specific pet health insight — whisker fatigue, a real and common issue where cats are stressed by their whiskers touching the sides of a narrow bowl. The NomNom's wide, shallow design eliminated the trigger.</p>
            <p>It also had a raised lip to catch food debris and keep floors clean — a pet owner problem, not just a pet problem. The product solved for both simultaneously.</p>
          ...
          <section className="project-section">
            ...
            <p>Early on I learned that a beautiful rendering means nothing if the person reading it in a factory in another country interprets a single dimension differently.</p>
            <p>I developed a documentation practice built around precision and redundancy: detailed SOPs, annotated technical drawings, physical samples at every stage, and explicit sign-off checkpoints before production began. I learned to write briefs that left no room for interpretation — and when language was a barrier, to communicate through drawings, samples, and side-by-side comparisons.</p>
          ...
          <section className="project-section">
            ...
            <p>The negotiation was structured and straightforward. I identified and valued the tangible assets: IP, inventory, web assets, email list, factory relationships. Some line items came in below my initial expectations, but the inventory buyout addressed my most significant liability.</p>
            <p>More importantly, the trust built during the process led to a post-acquisition consulting arrangement — I continued designing new products for the brand under my original creative direction. That outcome doesn't happen without mutual respect on both sides of the table.</p>
          ...
          <section className="project-section">
            ...
            <p><strong>Micro and macro have to work together.</strong> I am a detail-oriented person by training and temperament. But 13 years of running a business taught me that detail work without strategic context is just noise.</p>
            <p>Every decision I make now starts with the same question: what is the high-level business or customer goal this feeds into? Once I understand that, I can make detail decisions with confidence — because I know what I'm optimizing&nbsp;for.</p>
          </section>
