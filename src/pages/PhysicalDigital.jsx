        ...
        <div className="project-body">
          ...
          <div className="project-chapter">
            ...
            <section className="project-section">
              ...
              <p>Eighteen years of consulting across dozens of clients and categories built one capability above all others: the ability to communicate design across every kind of gap. Inventors and solo founders see their product one way. Engineers see it another. Factory managers in three different countries see it three more ways. Getting an idea out of someone's head, through a design process, through production, and into a market — without losing what made it worth making in the first place — is fundamentally a communication problem.</p>
          ...
          <div className="project-chapter">
            ...
            <section className="project-section">
              <h2>The Audience</h2>
              <p>Designing for SolidWorks users is unlike designing for most software audiences. These are professional engineers who have spent years — sometimes decades — mastering an extraordinarily complex tool. Many exhibit what might be called the IKEA effect at scale: they've worked so hard to learn the software that they take genuine pride in that complexity. They don't want it simplified. They want it respected.</p>
