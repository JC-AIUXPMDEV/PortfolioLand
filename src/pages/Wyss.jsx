      ...
      <div className="project-detail">
        ...
        <div className="project-body">
          ...
          <section className="project-section">
            ...
            <p>The existing prototype addressed this through brute force: an extremely tight compression undergarment with rigid straps that cinched the actuator to the body, concealed by an outer shirt styled like a factory uniform. The concept had merit as a product direction. But the mounting points weren't stable enough to transfer force effectively, the garment was uncomfortable to wear for any extended period, and the system hadn't resolved the fundamental tension between what the engineering required and what a body would actually&nbsp;tolerate.</p>
          </section>
